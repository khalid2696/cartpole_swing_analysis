...
%% Load the cartpole dynamics
if ~exist('cartPoleParameters','var') || ~exist('dynamicsFnHandle','var')
    load('cartpoleDynamics.mat');
end
...
% Specify initial and final state: [pos, vel, theta, omega]
